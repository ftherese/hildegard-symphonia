...
% The title:
\begin{center}\begin{huge}\textsc{O Eterne Deus}\end{huge}\end{center}
...
\gresetfirstlineaboveinitial{\small \textsc{\textbf{RC III}}}{\small \textsc{\textbf{RC III}}}

% We type a text in the top right corner of the score:
\commentary{{\small \emph{O Eternal God}}}

% and finally we include the score. The file must be in the same directory as this one.
\includescore{o-eterne-deus.tex}
