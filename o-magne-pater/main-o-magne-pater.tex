...
% The title:
\begin{center}\begin{huge}\textsc{O Magne Pater}\end{huge}\end{center}
...
\gresetfirstlineaboveinitial{\small \textsc{\textbf{RC II}}}{\small \textsc{\textbf{RC II}}}

% We type a text in the top right corner of the score:
\commentary{{\small \emph{Responsorial: O Eternal Power}}}

% and finally we include the score. The file must be in the same directory as this one.
\includescore{o-magne-pater.tex}
