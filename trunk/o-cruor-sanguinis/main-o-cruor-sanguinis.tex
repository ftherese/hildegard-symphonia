...
% The title:
\begin{center}\begin{huge}\textsc{O cruor sanguinis}\end{huge}\end{center}
...
\gresetfirstlineaboveinitial{\small \textsc{\textbf{RC V}}}{\small \textsc{\textbf{RC V}}}

% We type a text in the top right corner of the score:
\commentary{{\small \emph{Antiphon: O Outpoured Blood}}}

% and finally we include the score. The file must be in the same directory as this one.
\includescore{o-cruor-sanguinis.tex}
