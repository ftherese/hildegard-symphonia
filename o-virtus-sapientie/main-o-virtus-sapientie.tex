...
% The title:
\begin{center}\begin{huge}\textsc{O virtus Sapientie}\end{huge}\end{center}
...
\gresetfirstlineaboveinitial{\small \textsc{\textbf{RC IV}}}{\small \textsc{\textbf{RC IV}}}

% We type a text in the top right corner of the score:
\commentary{{\small \emph{Antiphon: O virtue of Wisdom}}}

% and finally we include the score. The file must be in the same directory as this one.
\includescore{o-virtus-sapientie.tex}
