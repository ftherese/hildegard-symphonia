...
% The title:
\begin{center}\begin{huge}\textsc{O Vis Eternitatis}\end{huge}\end{center}
...
\gresetfirstlineaboveinitial{\small \textsc{\textbf{RC I}}}{\small \textsc{\textbf{RC I}}}

% We type a text in the top right corner of the score:
\commentary{{\small \emph{Riesencodex and Sequentia}}}

% and finally we include the score. The file must be in the same directory as this one.
\includescore{o-vis-eternitatis.tex}
