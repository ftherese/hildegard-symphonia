...
% The title:
\begin{center}\begin{huge}\textsc{Ave generosa}\end{huge}\end{center}
...
\gresetfirstlineaboveinitial{\small \textsc{\textbf{RC XVII}}}{\small \textsc{\textbf{RC XVII}}}

% We type a text in the top right corner of the score:
\commentary{{\small \emph{Hail Glorious Maiden}}}

% and finally we include the score. The file must be in the same directory as this one.
\includescore{ave-generosa.tex}
