...
% The title:
\begin{center}\begin{huge}\textsc{O spelndidissima gemma}\end{huge}\end{center}
...
\gresetfirstlineaboveinitial{\small \textsc{\textbf{RC 10}}}{\small \textsc{\textbf{RC 10}}}

% We type a text in the top right corner of the score:
\commentary{{\small \emph{O Resplendent Jewel}}}

% and finally we include the score. The file must be in the same directory as this one.
\includescore{o-splendidissima-gemma.tex}
